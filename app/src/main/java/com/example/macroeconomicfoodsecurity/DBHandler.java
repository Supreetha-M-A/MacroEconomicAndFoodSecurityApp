...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME_FDIOutFlowsPERCENT = "fdi_outflows";
    private static final String TABLE_NAME_GDP_Agri = "gdp_agri";
    private static final String TABLE_NAME_FertilizerCons = "fertilizer_consum";
    ...
    public void createTable(){
        ...
        Log.e("CreatNewTable", "Creating table" + TABLE_NAME_FDIOutFlowsPERCENT);
        String query1 = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME_FDIOutFlowsPERCENT + " ("
                + YEAR + " TEXT, "
                + India_COUNTRY + " TEXT,"
                + CHINA_COUNTRY + " TEXT,"
        ...
        Log.e("CreatNewTable", "Creating table" + TABLE_NAME_GDP_Agri);
         query1 = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME_GDP_Agri + " ("
                + YEAR + " TEXT, "
                + India_COUNTRY + " TEXT,"
                + CHINA_COUNTRY + " TEXT,"
        ...
        Log.e("CreatNewTable", "Creating table" + TABLE_NAME_FertilizerCons);
        query1 = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME_FertilizerCons + " ("
                + YEAR + " TEXT, "
                + India_COUNTRY + " TEXT,"
                + CHINA_COUNTRY + " TEXT,"
...
//        db.execSQL(query);
    ...
    public ArrayList<Model> readFertiliserConsump() {
        // on below line we are creating a
        // database for reading our database.
        SQLiteDatabase db = this.getReadableDatabase();

        // on below line we are creating a cursor with query to read data from database.
        Cursor cursorCourses = db.rawQuery("SELECT * FROM " + TABLE_NAME_FertilizerCons
                , null);
    ...
    public ArrayList<Model> readGDPAgriValues() {
        // on below line we are creating a
        // database for reading our database.
        SQLiteDatabase db = this.getReadableDatabase();

        // on below line we are creating a cursor with query to read data from database.
        Cursor cursorCourses = db.rawQuery("SELECT * FROM " + TABLE_NAME_GDP_Agri
                , null);
    ...
    public ArrayList<Model> readFDIOutFlowsPercentValues() {
        // on below line we are creating a
        // database for reading our database.
        SQLiteDatabase db = this.getReadableDatabase();

        // on below line we are creating a cursor with query to read data from database.
        Cursor cursorCourses = db.rawQuery("SELECT * FROM " + TABLE_NAME_FDIOutFlowsPERCENT
                , null);
    ...
    public void addNewFDIOutFlows(String[] inValues) {
        ...
        // on below line we are passing all values
        // along with its key and value pair.
        Log.e("FDOutFLOWS", inValues[0] + " " + inValues[1]);
        values.put(YEAR, inValues[0]);
        values.put(CHINA_COUNTRY, inValues[1]);
        values.put(India_COUNTRY, inValues[2]);
        values.put(USA_COUNTRY, inValues[3]);
        ...
        // after adding all values we are passing
        // content values to our table.
        db.insert(TABLE_NAME_FDIOutFlowsPERCENT, null, values);
    ...
    public void addNewGDPAgri(String[] inValues) {
        Log.e("GDPAGRI" , inValues[0] + inValues[1]);
        // on below line we are creating a variable for
        // our sqlite database and calling writable method
        // as we are writing data in our database.
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        // on below line we are passing all values
        // along with its key and value pair.
       Log.e("GDP AGRI" , inValues[0] + inValues[1]);
        values.put(YEAR, inValues[0]);
        values.put(CHINA_COUNTRY, inValues[1]);
        values.put(India_COUNTRY, inValues[2]);
        values.put(USA_COUNTRY, inValues[3]);
        ...
        // after adding all values we are passing
        // content values to our table.
        db.insert(TABLE_NAME_GDP_Agri, null, values);
    ...
    public void addFertilizerConsum(String[] inValues) {
        Log.e("GDPAGRI" , inValues[0] + inValues[1]);
        // on below line we are creating a variable for
        // our sqlite database and calling writable method
        // as we are writing data in our database.
        ...
        // after adding all values we are passing
        // content values to our table.
        db.insert(TABLE_NAME_FertilizerCons, null, values);
