...
public final class ActivityTradeGraphBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTradeGraphBinding(@NonNull LinearLayout rootView, @NonNull Button annotateButton,
      @NonNull Button button5, @NonNull EditText editTextNumber,
  ...
  @NonNull
  public static ActivityTradeGraphBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTradeGraphBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_trade_graph, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTradeGraphBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTradeGraphBinding((LinearLayout) rootView, annotateButton, button5,
